...
!Fluxes (OUT)
REAL(KIND=real_jlslsm), INTENT(OUT) ::                                         &
alb_sicat(t_i_length * t_j_length, nice_use, 4),                               &
penabs_rad_frac(t_i_length * t_j_length, nice_use, 4)
